"""CT_TOX Pipeline - Clinical Toxicity Prediction using Self-Training"""
...
def train_self_training(X_train, y_train, X_unlabeled, X_val, y_val, threshold=0.75, target_size=2500):
    """
...
def run_pipeline():
    """Main pipeline execution for CT_TOX."""
    print("="*60)
    print("🔬 CT_TOX PIPELINE (Clinical Toxicity)")
    print("="*60)
